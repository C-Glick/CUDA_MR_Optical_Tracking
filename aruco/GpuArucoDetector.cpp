...
struct GpuArucoDetector::ArucoDetectorImpl {
...
GpuArucoDetector::GpuArucoDetector(const Dictionary &_dictionary,
...
GpuArucoDetector::GpuArucoDetector(const vector<Dictionary> &_dictionaries,
                             const DetectorParameters &_detectorParams,
                             const RefineParameters& _refineParams) {
    arucoDetectorImpl = makePtr<ArucoDetectorImpl>(_dictionaries, _detectorParams, _refineParams);
}

void GpuArucoDetector::detectMarkersWithConfidence(InputArray _image, OutputArrayOfArrays _corners, OutputArray _ids, OutputArray _markersConfidence,
...
void GpuArucoDetector::detectMarkers(InputArray _image, OutputArrayOfArrays _corners, OutputArray _ids,
                                  OutputArrayOfArrays _rejectedImgPoints) const {
    arucoDetectorImpl->detectMarkers(_image, _corners, _ids, _rejectedImgPoints, noArray(), noArray(), DictionaryMode::Single);
}

void GpuArucoDetector::detectMarkersMultiDict(InputArray _image, OutputArrayOfArrays _corners, OutputArray _ids,
...
void GpuArucoDetector::refineDetectedMarkers(InputArray _image, const Board& _board,
...
void GpuArucoDetector::write(FileStorage &fs) const {
...
void GpuArucoDetector::read(const FileNode &fn) {
...
const Dictionary& GpuArucoDetector::getDictionary() const {
    return arucoDetectorImpl->dictionaries[0];
}

void GpuArucoDetector::setDictionary(const Dictionary& dictionary) {
...
vector<Dictionary> GpuArucoDetector::getDictionaries() const {
    return arucoDetectorImpl->dictionaries;
}

void GpuArucoDetector::setDictionaries(const vector<Dictionary>& dictionaries) {
    CV_Assert(!dictionaries.empty());
    arucoDetectorImpl->dictionaries = dictionaries;
}

const DetectorParameters& GpuArucoDetector::getDetectorParameters() const {
    return arucoDetectorImpl->detectorParams;
}

void GpuArucoDetector::setDetectorParameters(const DetectorParameters& detectorParameters) {
    arucoDetectorImpl->detectorParams = detectorParameters;
}

const RefineParameters& GpuArucoDetector::getRefineParameters() const {
    return arucoDetectorImpl->refineParams;
}

void GpuArucoDetector::setRefineParameters(const RefineParameters& refineParameters) {
